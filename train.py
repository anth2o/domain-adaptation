...
if architecture == 'CNN':
    ...
    model = CNNGRL()
    model._run_all(x_train, x_test, y_train, y_test, x_train_unlabelled, y_train_unlabelled, x_test_unlabelled, y_test_unlabelled, pre_trained_model_name='cnn_train_svhn')
